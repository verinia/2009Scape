...
import core.game.content.activity.allfiredup.AFUBeacon
import core.game.node.entity.skill.Skills

@Initializable
class ElementalWorkshop : Quest("Elemental Workshop", 52, 51, 1) {
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            if (stage >= 10) {
                ...
                line(
                    player,
                    "to speak with !!Blaze Sharpeye??, by the beacon near the !!River Salve??.",
                    line++,
                    stage >= 20
                )
            }
            ...
            if (stage >= 40) {
                line(
                    player,
                    "Blaze Sharpeye asked me to go and speak with !!Squire Fyre?? near the !!limestone quarry??.",
                    line++,
                    stage >= 50
                )
            }
            if (stage >= 50) {
                line(
                    player,
                    "Squire Fyre permitted me to light the !!beacon??. I'm going to need:",
                    line++,
                    stage >= 60
                )
